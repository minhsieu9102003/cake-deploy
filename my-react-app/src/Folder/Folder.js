...
function Folder() {
    ...
    return (
        <div>
            <form className="main__popup" style={{ display: popupStatus ? 'flex' : 'none' }}>
                <div className="main__popup-inner">
                    <button className="main__cross" type="button" onClick={handleClosePopup}>
                    ...
                    <input type="text" placeholder="Folder title" />
                    <div className="main__popup-submit-container">
                        <button className="main__popup-submit">Save</button>
                    </div>
                </div>
            </form>
            ...
            <div className="navigation">
                ...
                <div className="navigation__search-box">
                    <svg className="navigation__search-box-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 32 32">
                        <path
                ...
                <ul className="navigation__link">
                    <div className="navigation__dropdown">
                        <button onClick={handleDropdownClick}>
                            ...
                            <svg width="15" className="form__month--arrow-brown" height="15" viewBox="0 0 28 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div className="first">
                <div className="first__heading">
                    <div className="first__title">
                        <h1>My Folder</h1>
                        <svg className="first__paw" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
                            <path fill="#FBCF26"
                    ...
                    <svg className="first__back" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                        <style>
                            {`
                                .st0 {
                                    display: none;
                ...
                <div className="first__filter">
                    <div className="form__month">
                        <button className="form__month--button" role="combobox" aria-labelledby="select button" aria-haspopup="listbox" aria-expanded={customSelectActive ? "true" : "false"} aria-controls="select-dropdown" onClick={handleSelectClick}>
                        ...
                        <ul className={`form__month--dropdown ${customSelectActive ? 'active' : ''}`} role="listbox" id="select-dropdown">
                    ...
                    <svg className="first__plus" width="800px" height="800px" viewBox="0 0 32 32" onClick={handlePopupClick} xmlns="http://www.w3.org/2000/svg">
                        <title>plus-circle</title>
                        <desc>Created with Sketch Beta.</desc>
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <g id="Icon-Set" transform="translate(-464.000000, -1087.000000)" fill="#7a4a4a">
                                <path
            ...
            <section className="main">
                {[...Array(8)].map((_, i) => (
                    <div className="main__folder" key={i}>
                        <svg className="main__folder-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                            <defs>
                                <style>
                                    {`
                                        .cls-2 {
                            ...
                            <g id="File_and_folder" data-name="File and folder">
                                ...
                                <path
                                    ...
                                    style={{ fill: '#fc6' }}
                                />
                                <path d="M47 23v22H34A30.09 30.09 0 0 1 4 15h11.93a2 2 0 0 1 1.66.89L21 21h24a2 2 0 0 1 2 2z" style={{ fill: '#ffde76' }} />
                                <path className="cls-2" d="M36 7v14H21l-3.41-5.11a2 2 0 0 0-1.66-.89H6V7z" />
                                <path d="M36 7v12H23l-3.41-5.11a2 2 0 0 0-1.66-.89H15a6 6 0 0 1-6-6h27z" style={{ fill: '#edebf2' }} />
                                <path
                                    className="cls-6"
                        ...
                        <span className="main__folder-title">Biology12</span>
                    </div>
                ))}
            </section>
            ...
            <footer className="footer">
                ...
                <div className="footer__text-container">
                    ...
                    {[...Array(3)].map((_, i) => (
                        <h4 key={i} className={`footer__h4-author-${i + 1}`}>minh</h4>
                    ))}
                ...
                <div className="footer__text-container-1">
                    ...
                    <h4 className="footer__h4-acknowledge">
                        A project for Hanoi University of Science and Technology's Web Subject Course
                    </h4>
                </div>
            </footer>
        </div>
