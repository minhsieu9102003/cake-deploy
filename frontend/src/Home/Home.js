...
function Home() {
  ...
  useEffect(() => {
    ...
    tl.fromTo('.header',
      ...
      { opacity: 1, transform: 'translateY(0) translateX(0)', ease: 'bounce.out' }
    );
    ...
    <div className="all">
      ...
      <div className="navigation">
        ...
        <ul className="navigation__link">
          ...
          <li className="navigation__link-btn">
            ...
            <Link to="/login" className='navigation__link-btn-a'>Sign in</Link>
          </li>
          <li className="navigation__link-btn sign-up">
            <Link to="/signup" className='navigation__link-btn-a sign-up'>Sign up</Link>
          </li>
      ...
      <div className="section">
        <div className="header">
          ...
          <h4 className="header__secondary">Dive into CAKE's personalized English learning with expert tutors. Enjoy quick progress in a supportive environment. Start your simplified journey to fluency today</h4>
          <a href="#" className='header__button button--brown button'>Let's go</a>
      ...
      <div className="section-2">
        ...
        <div className="section-2__main">
          <div className="quick">
            ...
            <p className="quick__text">Explore 'Quick Bites' quizzes to boost your English. From grammar puzzles to vocabulary tests, these fun, bite-sized challenges fit any schedule, offering a flexible way to improve your skills quiz by quiz.</p>
          </div>
          <div className="flash">
            ...
            <p class="flash__text">Introducing 'Flash Slices'—your shortcut to mastering English. With each
              card, tackle vocabulary and grammar quickly, ensuring lessons stick. Perfect for rapid learning
              and recall, 'Flash Slices' streamline your English journey</p>
          </div>
        </div>
      </div>
      ...
      <footer className="footer">
        <div className="footer__img-container">
          <img src={cakeLogoBig} alt="Large Cake Logo" className="footer__logo" />
